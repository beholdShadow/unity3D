	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 texCoord81_g32 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord41 = IN.ase_texcoord3.xy * float2( 4,4 ) + float2( 0,0 );
				float2 temp_output_29_0_g32 = ( texCoord41 - float2( 2,2 ) );
				float2 appendResult39_g32 = (float2(frac( ( atan2( (temp_output_29_0_g32).x , (temp_output_29_0_g32).y ) / TWO_PI ) ) , length( temp_output_29_0_g32 )));
				float2 temp_output_127_0 = ( ( (tex2D( _Sampler60127, ( ( float2( 1,1 ) * texCoord81_g32 ) + ( texCoord81_g32 + ( float2( 0,0 ) * _TimeParameters.x ) ) ) )).rg * 1.0 ) + ( float2( 1,1 ) * ( ( float2( 0,0 ) * _TimeParameters.x ) + appendResult39_g32 ) ) );
				float2 panner9 = ( _TimeParameters.x * float2( 0,-0.2 ) + temp_output_127_0);
				float2 texCoord2_g34 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_9_0_g34 = ( distance( texCoord2_g34 , float2( 0.5,0.5 ) ) / 1.0 );
				float temp_output_3_0_g35 = ( 1.0 - temp_output_9_0_g34 );
				float temp_output_14_0_g34 = 1.5;
				float temp_output_9_0_g35 = ( temp_output_3_0_g35 * temp_output_14_0_g34 );
				float ifLocalVar15_g35 = 0;
				if( temp_output_3_0_g35 <= 0.0 )
				ifLocalVar15_g35 = 1.0;
				else
				ifLocalVar15_g35 = ( 1.0 / pow( 2.718282 , ( temp_output_9_0_g35 * temp_output_9_0_g35 ) ) );
				float temp_output_3_0_g36 = temp_output_9_0_g34;
				float temp_output_9_0_g36 = ( temp_output_3_0_g36 * temp_output_14_0_g34 );
				float ifLocalVar15_g36 = 0;
				if( temp_output_3_0_g36 <= 0.0 )
				ifLocalVar15_g36 = 1.0;
				else
				ifLocalVar15_g36 = ( 1.0 / pow( 2.718282 , ( temp_output_9_0_g36 * temp_output_9_0_g36 ) ) );
				float temp_output_125_0 = sin( ( ( ( 1.0 - sin( ( ( abs( ( tex2D( _Noise, panner9 ).r + ( (temp_output_127_0).y - 1.0 ) ) ) + _TimeParameters.x ) * ( ( ( 1.0 / 0.5 ) * 2.0 ) * PI ) ) ) ) * pow( ( (float)(int)0.0 == 0.0 ? ( 1.0 - ifLocalVar15_g35 ) : ifLocalVar15_g36 ) , 12.0 ) ) * ( ( ( 1.0 / 5.0 ) * 2.0 ) * PI ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord81_g32 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord41 = IN.ase_texcoord2.xy * float2( 4,4 ) + float2( 0,0 );
				float2 temp_output_29_0_g32 = ( texCoord41 - float2( 2,2 ) );
				float2 appendResult39_g32 = (float2(frac( ( atan2( (temp_output_29_0_g32).x , (temp_output_29_0_g32).y ) / TWO_PI ) ) , length( temp_output_29_0_g32 )));
				float2 temp_output_127_0 = ( ( (tex2D( _Sampler60127, ( ( float2( 1,1 ) * texCoord81_g32 ) + ( texCoord81_g32 + ( float2( 0,0 ) * _TimeParameters.x ) ) ) )).rg * 1.0 ) + ( float2( 1,1 ) * ( ( float2( 0,0 ) * _TimeParameters.x ) + appendResult39_g32 ) ) );
				float2 panner9 = ( _TimeParameters.x * float2( 0,-0.2 ) + temp_output_127_0);
				float2 texCoord2_g34 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_9_0_g34 = ( distance( texCoord2_g34 , float2( 0.5,0.5 ) ) / 1.0 );
				float temp_output_3_0_g35 = ( 1.0 - temp_output_9_0_g34 );
				float temp_output_14_0_g34 = 1.5;
				float temp_output_9_0_g35 = ( temp_output_3_0_g35 * temp_output_14_0_g34 );
...
/*ASEBEGIN
Version=18935
974;73;945;797;670.3488;724.0728;2.164737;True;False
...
Node;AmplifyShaderEditor.FunctionNode;127;-1361.655,-72.55724;Inherit;False;RadialUVDistortion;-1;;32;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler60127;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;1,1;False;105;FLOAT2;0,0;False;29;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;126;242.3972,211.7375;Inherit;False;Sine;-1;;37;11642aafbceb1d84888607964d84f440;0;2;3;FLOAT;0;False;8;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;91;270.5858,390.715;Inherit;False;RadialGradientExponential;-1;;34;6d0f11b3064a72545afe50c41b9a5b7b;0;5;1;FLOAT2;0,0;False;5;FLOAT2;0.5,0.5;False;8;FLOAT;0;False;14;FLOAT;0;False;19;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;125;963.132,286.6699;Inherit;False;Sine;-1;;38;11642aafbceb1d84888607964d84f440;0;2;3;FLOAT;0;False;8;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=EE72D32158368E0636FE9DC4A0C07153F73AAFAD