...
Shader "ASEShader/ParticleBlend"
{
	Properties
	{
		...
		[HDR]_Tint("Tint", Color) = (1.945098,1.945098,1.945098,1)
		[ASEEnd][HDR]_EmissiveTint("EmissiveTint", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_12_0 = ( _Tint * tex2D( _Texture, uv_Texture ) * IN.ase_color );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _EmissiveTint + temp_output_12_0 ).rgb;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = (temp_output_12_0).a;
...
/*ASEBEGIN
Version=18935
1134;73;785;500;1362.055;614.6661;2.493494;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-234.9183,-7.290344;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;7;-46.34093,-35.40482;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;15;-287.0294,-224.4816;Inherit;False;Property;_EmissiveTint;EmissiveTint;2;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SwizzleNode;16;-39.72175,86.66653;Inherit;False;FLOAT;3;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=78811068A81B87F12F64618C1BF838B3500CBAD3