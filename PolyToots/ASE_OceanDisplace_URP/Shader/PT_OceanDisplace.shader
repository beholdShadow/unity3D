...
Shader "PolyToots/ASE_OceanDisplace"
{
	Properties
	{
		...
		[ASEBegin]_SeaColor("Sea Color", Color) = (0.03163936,0.6067114,0.745283,1)
		_Displace_3D("Displace_3D", 3D) = "white" {}
		_Normals_3D("Normals_3D", 3D) = "white" {}
		_Distort("Distort", Range( 0 , 2)) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float _cheekySmoother338 = saturate( ( SAMPLE_TEXTURE2D_LOD( _WaveMask, sampler_WaveMask, (appendResult280*0.043 + 0.5), 0.0 ).r + ( 1.0 - _MaskStrength ) ) );
						 ...
						 ) : SV_Target
			{
				...
				float2 coords108 = (mul( unity_CameraToWorld, appendResult49_g10 )).xz * _CausticsScale;
				float2 id108 = 0;
				float2 uv108 = 0;
				...
				float eyeDepth28_g13 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float2 temp_output_20_0_g13 = ( (normals123).xy * ( _Distort / max( eyeDepth , 0.1 ) ) * saturate( ( eyeDepth28_g13 - eyeDepth ) ) );
				float eyeDepth2_g13 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ( float4( temp_output_20_0_g13, 0.0 , 0.0 ) + ase_screenPosNorm ).xy ),_ZBufferParams);
				float2 temp_output_32_0_g13 = (( float4( ( temp_output_20_0_g13 * saturate( ( eyeDepth2_g13 - eyeDepth ) ) ), 0.0 , 0.0 ) + ase_screenPosNorm )).xy;
				float2 temp_output_425_38 = temp_output_32_0_g13;
				float2 _refractUV168 = temp_output_425_38;
				...
				float4 fetchOpaqueVal149 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( temp_output_425_38 ), 1.0 );
...
/*ASEBEGIN
Version=18935
1197;73;722;610;693.3124;297.2817;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-3645.677,-1484.815;Inherit;False;Property;_Tiling;Tiling;7;0;Create;True;0;0;0;False;0;False;1;0.12;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-3421.677,-1344.457;Inherit;False;Property;_WaveSpeed;Wave Speed;8;0;Create;True;0;0;0;False;0;False;0.4;0.31;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;395;-2158.52,-1419.701;Inherit;False;677.3872;403.3722;Comment;3;392;391;106;SideFix;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-2033.602,-1366.494;Inherit;False;Property;_NormalPower;Normal Power;4;0;Create;True;0;0;0;False;0;False;1;0.684;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;140;-1405.224,-1399.072;Inherit;False;1011.688;304.9631;Comment;3;123;66;331;Normals;1,1,1,1;0;0
Node;AmplifyShaderEditor.WorldNormalVector;391;-1971.53,-1207.129;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;331;-1255.073,-1341.136;Inherit;False;127;_3duvs;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;392;-1746.535,-1280.013;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;66;-1028.703,-1343.071;Inherit;True;Property;_Normals_3D;Normals_3D;2;0;Create;True;0;0;0;False;0;False;-1;f22f07d7d96d4be4bbc482264062f337;15730400ed428da42a95ec30431ce5d4;True;0;False;white;LockedToTexture3D;True;Object;-1;Auto;Texture3D;8;0;SAMPLER3D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;6.77;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;151;-4662.679,-1003.585;Inherit;False;1302.432;449.3139;Comment;5;189;148;149;168;152;Refraction + UVs;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;123;-654.0866,-1319.582;Inherit;False;normals;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;152;-4610.243,-946.8492;Inherit;False;123;normals;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;148;-4623.94,-794.5775;Inherit;False;Property;_Distort;Distort;3;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;425;-4323.582,-924.8124;Inherit;False;DepthMaskedRefraction;-1;;13;c805f061214177c42bca056464193f81;2,103,0,40,0;2;35;FLOAT3;0,0,0;False;37;FLOAT;0.02;False;1;FLOAT2;38
...
Node;AmplifyShaderEditor.GetLocalVarNode;235;-3911.063,-2542.533;Inherit;False;168;_refractUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SurfaceDepthNode;240;-3749.11,-2419.818;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;291;-4005.378,-376.6408;Inherit;False;1766.387;542.8701;Comment;10;336;288;333;289;280;290;282;279;337;338;Cheeky Wave Smoother;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;251;-3720.196,-2245.465;Inherit;False;Property;_Depth;Depth;6;0;Create;True;0;0;0;False;0;False;1;0.641;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenDepthNode;238;-3709.781,-2543.492;Inherit;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;60;-1890.078,-2508.9;Inherit;False;1919.79;438.3458;Comment;10;273;145;117;108;17;131;144;143;341;415;Caustics;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;279;-3955.377,-326.6407;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;131;-1386.502,-2341.774;Inherit;False;130;_Time;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;415;-1660.178,-2456.98;Inherit;False;Reconstruct World Position From Depth;-1;;10;e7094bcbcc80eb140b2a3dbe6a861de8;0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;290;-3798.776,-62.41321;Inherit;False;Constant;_ProjectionOffset;ProjectionOffset;13;0;Create;True;0;0;0;False;0;False;0.5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;280;-3754.271,-292.5177;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;282;-3798.816,-149.3612;Inherit;False;Constant;_ProjectionScale;ProjectionScale;12;0;Create;True;0;0;0;False;0;False;0.043;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;144;-1201.216,-2255.912;Inherit;False;Property;_CausticsScale;Caustics Scale;11;0;Create;True;0;0;0;False;0;False;5;11.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;289;-3484.735,-193.5992;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SaturateNode;256;-3069.247,-2263.274;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;333;-3411.11,-8.439125;Inherit;False;Property;_MaskStrength;Mask Strength;14;0;Create;True;0;0;0;False;0;False;1;0.632;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;17;-1213.015,-2462.827;Inherit;False;True;False;True;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;143;-1196.805,-2368.616;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;8;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;108;-937.5518,-2462.399;Inherit;True;0;1;1;3;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;5;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.OneMinusNode;411;-3025.168,41.67059;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;253;-2906.712,-2268.199;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;288;-3250.585,-223.5101;Inherit;True;Property;_WaveMask;WaveMask;13;0;Create;True;0;0;0;False;0;False;-1;9e4afcd6d6fda81418ccf68f6cded108;9e4afcd6d6fda81418ccf68f6cded108;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;336;-2876.816,-201.2652;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;273;-711.0224,-2447.74;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.38;False;2;FLOAT;1.25;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;129;-1844.363,-777.1763;Inherit;False;127;_3duvs;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;117;-473.5993,-2379.29;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;341;-569.7357,-2292.397;Inherit;False;Property;_CausticsColour;Caustics Colour;12;1;[HDR];Create;True;0;0;0;False;0;False;2,2,2,0;0.578127,1.776274,1.556072,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;263;520.2737,-2229.927;Inherit;False;189;_distortion;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;337;-2701.654,-196.4051;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-1888.74,-358.4025;Inherit;False;Property;_WaveHeight;Wave Height;10;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;141;-1640.255,-567.3534;Inherit;False;Constant;_Vector0;Vector 0;9;0;Create;True;0;0;0;False;0;False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;338;-2510.703,-197.3552;Inherit;False;_cheekySmoother;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;142;-1432.733,-523.4811;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;304;1053.222,-2066.687;Inherit;False;Property;_EdgePower;Edge Power;9;0;Create;True;0;0;0;False;0;False;0.3;0.475;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;67;-2992.201,-805.8253;Inherit;False;Property;_SeaColor;Sea Color;0;0;Create;True;0;0;0;False;0;False;0.03163936,0.6067114,0.745283,1;0,0.370999,0.4039215,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;277;-992.5174,-591.9963;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;301;1496.638,-2373.642;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-245.885,105.5595;Inherit;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;0.9;0.825;0;1;0;1;FLOAT;0
...
WireConnection;425;35;152;0
WireConnection;425;37;148;0
WireConnection;168;0;425;38
...
ASEEND*/
//CHKSM=1090B43853807E704AC1C4E217A96EF0748B271F