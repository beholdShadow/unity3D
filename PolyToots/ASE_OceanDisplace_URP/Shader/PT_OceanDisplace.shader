...
Shader "PolyToots/ASE_OceanDisplace"
{
	Properties
	{
		...
		[ASEBegin]_SeaColor("Sea Color", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 UV22_g123 = ase_screenPosNorm.xy;
				float2 localUnStereo22_g123 = UnStereo( UV22_g123 );
				float2 break64_g122 = localUnStereo22_g123;
				float clampDepth69_g122 = SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy );
				#ifdef UNITY_REVERSED_Z
				float staticSwitch38_g122 = ( 1.0 - clampDepth69_g122 );
				#else
				float staticSwitch38_g122 = clampDepth69_g122;
				#endif
				...
				float eyeDepth28_g130 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float2 temp_output_20_0_g130 = ( (normals123).xy * ( _Distort / max( eyeDepth , 0.1 ) ) * saturate( ( eyeDepth28_g130 - eyeDepth ) ) );
				float eyeDepth2_g130 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ( float4( temp_output_20_0_g130, 0.0 , 0.0 ) + ase_screenPosNorm ).xy ),_ZBufferParams);
				float2 temp_output_32_0_g130 = (( float4( ( temp_output_20_0_g130 * saturate( ( eyeDepth2_g130 - eyeDepth ) ) ), 0.0 , 0.0 ) + ase_screenPosNorm )).xy;
				float2 temp_output_417_38 = temp_output_32_0_g130;
				float2 _refractUV168 = temp_output_417_38;
				...
				float4 fetchOpaqueVal149 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( temp_output_417_38 ), 1.0 );
...
/*ASEBEGIN
Version=18935
977;73;942;697;5031.106;1227.98;1;True;False
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;123;-506.3914,-1673.809;Inherit;False;normals;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;152;-4597.359,-936.2982;Inherit;False;123;normals;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;148;-4623.94,-794.5775;Inherit;False;Property;_Distort;Distort;3;0;Create;True;0;0;0;False;0;False;0.08510161;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;417;-4323.582,-924.8124;Inherit;False;DepthMaskedRefraction;-1;;130;c805f061214177c42bca056464193f81;2,40,0,103,0;2;35;FLOAT3;0,0,0;False;37;FLOAT;0.02;False;1;FLOAT2;38
...
Node;AmplifyShaderEditor.ColorNode;67;-2992.201,-805.8253;Inherit;False;Property;_SeaColor;Sea Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0.3709991,0.4039215,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;304;1053.222,-2066.687;Inherit;False;Property;_EdgePower;Edge Power;9;0;Create;True;0;0;0;False;0;False;1;0.289;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;121;1690.329,-2376.079;Inherit;False;emission;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;417;35;152;0
WireConnection;417;37;148;0
WireConnection;168;0;417;38
...
ASEEND*/
//CHKSM=BB68C8ED394D3A5F7207488594831B61C7BB2148