...
Shader "PolyToots/GodRay"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][HDR]_Color("Colour", Color) = (1,1,1,0)
		_Length("Length", Float) = 0.31
		_Strength("Strength", Range( 0 , 1)) = 1
		_Noise_Perlin("Noise_Perlin", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord18 = IN.ase_texcoord7.xy * float2( 0.1,2 ) + float2( 0,0 );
				float2 panner20 = ( _TimeParameters.x * float2( 0,-0.1 ) + texCoord18);
				float2 texCoord6 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_11_0 = ( tex2D( _Noise_Perlin, panner20 ).r + ( ( texCoord6.x - _Length ) * _Power ) );
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _Color * temp_output_11_0 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( saturate( ( temp_output_11_0 / 2.0 ) ) * _Strength );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord18 = IN.ase_texcoord2.xy * float2( 0.1,2 ) + float2( 0,0 );
				float2 panner20 = ( _TimeParameters.x * float2( 0,-0.1 ) + texCoord18);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord18 = IN.ase_texcoord3.xy * float2( 0.1,2 ) + float2( 0,0 );
				float2 panner20 = ( _TimeParameters.x * float2( 0,-0.1 ) + texCoord18);
...
/*ASEBEGIN
Version=18935
944;73;975;475;2170.593;843.4063;1.953851;True;False
Node;AmplifyShaderEditor.RangedFloatNode;9;-1635.455,189.5275;Inherit;False;Property;_Length;Length;1;0;Create;True;0;0;0;False;0;False;0.31;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;26;-1527.727,-351.2164;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;18;-1548.917,-548.12;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.1,2;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;6;-1608.782,-93.36179;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;7;-1341.054,41.61482;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1307.146,307.457;Inherit;False;Property;_Power;Power;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;20;-1278.413,-479.2234;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,-0.1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-1058.992,37.67322;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-989.8793,-461.9361;Inherit;True;Property;_Noise_Perlin;Noise_Perlin;3;0;Create;True;0;0;0;False;0;False;-1;4e09e53147d81cc42b740e149dca5022;4e09e53147d81cc42b740e149dca5022;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-655.5822,-132.8704;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;28;-533.3151,-43.66428;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;10;-679.6414,-420.3126;Inherit;False;Property;_Color;Colour;0;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-830.0558,327.0087;Inherit;False;Property;_Strength;Strength;2;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;23;-594.1738,100.4798;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-273.2711,147.4676;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-378.0996,-387.4847;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=FF12F6422E796D502CB229C8DD0D191D07E2D2F1